...
**Phase 8 measured lock (4,000 greedy, 4,000 random-legal and 4,000 undefended seeds):** spread attempt cap **3**, dwell **2**, spread chance **1.00** and infection lifetime **7**. Raw greedy survival is **97.30 percent**, retained as a diagnostic because filing now records a win for reportable incidents as well as clean containment. The competent outcome gate is therefore greedy wins below 25 percent final blast radius, which measured **69.75 percent** inside its 45-70 percent band. Random-legal wins measured **27.82 percent**; greedy and random average finishes were **T+12.63h** and **T+14.86h**; finishes before T+06h were **0.00 percent**; runs active after T+16h were **21.86 percent**; undefended loss was **100.00 percent**; and **25.40 percent** of greedy runs reached 80 percent business pressure. All eight corrected bands passed.
