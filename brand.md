...
- Body: Fira Code (bundled through Fontsource)
- Mono: Fira Code (bundled through Fontsource)
...
- Threat: 333 93% 56%
- Pressure: 38 91% 55%
- Border: 194 52% 38%, 4.06:1 against the base background
- Muted: 204 18% 65%, 7.95:1 against the base background
